export default class ColorRange {
  ...
  static inBlueGreenBoxA1(H, S) {
    return H >= 167 && H <= 193 && S >= 40 && S <= 100
  }

  static inBlueGreenBoxA2(H, S) {
    return H >= 193 && H <= 199 && S >= 90 && S <= 100
  }

  static inBlueGreenBoxB1(H, L) {
    return H >= 167 && H <= 194 && L >= 40 && L <= 60
  }

  static inBlueGreenBoxB2(H, L) {
    return H >= 174 && H <= 199 && L >= 15 && L <= 40
  }
  ...
  static inPinkBoxA1(H, S) {
    return H >= 291 && H <= 299 && S >= 94 && S <= 100
  }

  static inPinkBoxA2(H, S) {
    return H >= 299 && H <= 310 && S >= 67 && S <= 100
  }

  static inPinkBoxB1(H, L) {
    return H >= 291 && H <= 300 && L >= 37 && L <= 51
  }

  static inPinkBoxB2(H, L) {
    return H >= 297 && H <= 300 && L >= 51 && L <= 58
  }

  static inPinkBoxB3(H, L) {
    return H >= 300 && H <= 310 && L >= 31 && L <= 63
  }
  ...
  static inYellowBoxA1(H, S) {
    return H >= 46 && H <= 54 && S >= 70 && S <= 100
  }

  static inYellowBoxA2(H, S) {
    return H >= 54 && H <= 67 && S >= 60 && S <= 100
  }

  static inYellowBoxB1(H, L) {
    return H >= 47 && H <= 51 && L >= 40 && L <= 56
  }

  static inYellowBoxB2(H, L) {
    return H >= 46 && H <= 57 && L >= 19 && L <= 40
  }

  static inYellowBoxB3(H, L) {
    return H >= 51 && H <= 67 && L >= 40 && L <= 52
  }

  static inYellowBoxB4(H, L) {
    return H >= 57 && H <= 67 && L >= 29 && L <= 40 && L - 1.1 * H >= -34
  }
