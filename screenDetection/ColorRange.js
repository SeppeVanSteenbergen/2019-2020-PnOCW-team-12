class ColorRange {
  ...
  static lowerBoundMid() {
    return {H: 180 - this.sensitivity(), S: 50, L: 25}
  }

  static upperBoundMid() {
    return {H: 180 + this.sensitivity(), S: 100, L: 75}
  }

  static lowerBoundG() {
    return {H: 230 - this.sensitivity(), S: 50, L: 25}
  }

  static upperBoundG() {
    return {H: 230 + this.sensitivity(), S: 100, L: 75}
  }

  static lowerBoundB() {
    return {H: 120 - this.sensitivity(), S: 50, L: 25}
  }

  static upperBoundB() {
    return {H: 120 + this.sensitivity(), S: 100, L: 75}
  }
