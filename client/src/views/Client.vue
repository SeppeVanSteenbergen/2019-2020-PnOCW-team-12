...
export default {
  ...
  methods: {
    ...
    trackingUpdateHandler(data) {
      let newTransform = Sensors.transformationMatrix(this.trackingDefaultCSS, data.css).toString()
      document.getElementById('mainCanvas').style.transform = newTransform
    },
