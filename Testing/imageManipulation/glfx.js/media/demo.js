...
Filter.prototype.use = function() {
  ...
  $('#label').html(
    'Image credit: <a href="' + image.url + '">' + image.credit + '</a>'
  )
  ...
  $(
    '<tr><th></th><td><br>See the documentation for <kbd><a href="/glfx.js/docs/#' +
      this.func +
      '">' +
      this.func +
      '()</a></kbd> for more information.</td></tr>'
  ).appendTo(tbody)
...
var images = {
  'image.jpg': {
    credit: 'matthigh',
    url: 'http://www.flickr.com/photos/matthigh/2125630879/'
  },
  'lighthouse.jpg': {
    credit: 'renet',
    url: 'http://www.flickr.com/photos/renet/12135813/'
  },
  'perspective.jpg': {
    credit: 'stuckincustoms',
    url: 'http://www.flickr.com/photos/stuckincustoms/1213760517/'
  }
}
