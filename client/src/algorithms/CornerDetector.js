...
export default class CornerDetector {
  ...
  isValidOrder(pointList) {
    ...
    if (LU === null && RU === null) {
      ...
      return RD[2] === this.blue && LD[2] === this.blue
    } else if (LU === null) {
      let RD = pointList[2]

      if (RD !== null) {
        return RU[2] === this.green && RD[2] === this.blue
      } else {
        let LD = pointList[3]

        return RU[2] === this.green && LD[2] === this.blue
      }
    } else if (RU === null) {
      let RD = pointList[2]

      if (RD !== null) {
        return LU[2] === this.green && RD[2] === this.blue
      } else {
        let LD = pointList[3]

        return LU[2] === this.green && LD[2] === this.blue
      }
    } else {
      return LU[2] === this.green && RU[2] === this.green
    }
  }
